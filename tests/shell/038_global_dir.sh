...
assert_file_not_exists ./out/cfbs_global/
assert_file_not_exists ~/.cfengine/cfbs
...
assert_file_exists ./out/cfbs_global/downloads/github.com/cfengine/masterfiles/*
